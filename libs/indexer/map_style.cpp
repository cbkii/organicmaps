...
MapStyle MapStyleFromSettings(std::string const & str)
{
  ...
  else if (str == "MapStyleInCarLight")
    return MapStyleInCarLight;
  else if (str == "MapStyleInCarDark")
    return MapStyleInCarDark;
...
std::string MapStyleToString(MapStyle mapStyle)
{
  ...
  case MapStyleInCarDark: return "MapStyleInCarDark";
  case MapStyleInCarLight: return "MapStyleInCarLight";
...
{
  for (auto const darkStyle : {MapStyleDefaultDark, MapStyleVehicleDark, MapStyleOutdoorsDark, MapStyleInCarDark})
...
MapStyle GetDarkMapStyleVariant(MapStyle mapStyle)
{
  ...
  case MapStyleInCarLight: return MapStyleInCarDark;
...
MapStyle GetLightMapStyleVariant(MapStyle mapStyle)
{
  ...
  case MapStyleInCarDark: return MapStyleInCarLight;
